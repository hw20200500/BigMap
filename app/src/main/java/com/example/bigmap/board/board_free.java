                                                    ...
                                                    public void onComplete(t@NonNull Task<QuerySnapshot> task){
                                                        if(task.isSuccessful()){
                                                            ...
                                                            for (DocumentSnapshot document : task.getResult()){
                                                                ...
                                                                String content = document.getString("내용");
                                                                String user = document.getString("");
                                                                String time = document.getString("");

                                                                freelist_item item = new freelist_item(title, content, user, time);
                                                                itemList.add(item);
                                                            }
