...
public class qnalist_Adapter extends BaseAdapter {
    private Context context;
    private List<qnalist_item> listViewItemList;

    public qnalist_Adapter(Context context, List<qnalist_item> itemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.qnalist_item, parent, false);
        }

        qnalist_item item = listViewItemList.get(position);
